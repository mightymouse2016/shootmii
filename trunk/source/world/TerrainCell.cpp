...
TerrainCell::TerrainCell(
	...
	const int _width,
	const int _height) :
		Polygon(TERRAIN_LAYER,0,0,sqrt((_width/2)*(_width/2)+(_height/2)*(_height/2)),PI/4,0,false,false,NULL,Coordinates(-_width/2,-_height/2),_tileSet,EMPTY,_width,_height)
{
	vertices.reserve(4);
